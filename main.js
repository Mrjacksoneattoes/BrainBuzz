const animatedSections = document.querySelectorAll('.randomphrase,.slide-in-blurred-right,.slide-in-blurred-left,.slide-in-blurred-bottom,#incon1,.roll-in-bottom');
